...
<head>
    ...
    <title>管理首页</title>
    <link rel="stylesheet" type="text/css" href="css/top-area.css"/>
...
<div class="top-area">
    <ul class="menu-list">
        ...
        <li>
            <div class="firstA">
                <a href="SearchallServlet" target="phoneInfo" onclick="document.getElementById('cont1').style.display='block',
						document.getElementById('cont2').style.display='none',document.getElementById('cont3').style.display='none',
						document.getElementById('cont4').style.display='none',document.getElementById('cont5').style.display='none'">
                    手 机 信 息 </a>
            </div>
        </li>
        <li>
        ...
        <li>
            <div  class="thridA">
                <a href="SearchspeciesServlet" target="species" onclick="document.getElementById('cont3').style.display='block',
        ...
        <li>
            <div class="fourthA">
                <a href="#" onclick="document.getElementById('cont4').style.display='block',
					    document.getElementById('cont1').style.display='none',document.getElementById('cont2').style.display='none',
						document.getElementById('cont3').style.display='none',document.getElementById('cont5').style.display='none'">
                    <label>添 加 信 息</label> </a>
            </div>
        </li>
        <li>
            <div class="fifthA">
                <a href="#" onclick="document.getElementById('cont5').style.display='block',
					    document.getElementById('cont1').style.display='none',document.getElementById('cont2').style.display='none',
						document.getElementById('cont3').style.display='none',document.getElementById('cont4').style.display='none'">
                    <label>个人中心</label> </a>
            </div>
        </li>
    </ul>
...
<div class="jm">
    <div id="cont1" style="display:none">
        　 <iframe name="phoneInfo" width="1200px" height="800"></iframe>
    </div>
    <div id="cont2" style="display:none">
        　 <iframe src="selecttime.jsp" width="1200px" height="800"></iframe>
    </div>
    <div id="cont3" style="display:none">
        　 <iframe name="species" width="1200px" height="800"></iframe>
    </div>
    <div id="cont4" style="display:none">
        　 <iframe src="insert.jsp" width="1200px" height="800"></iframe>
    </div>
    <div id="cont5" style="display:block">
        　 <iframe src="SearchsellServlet" width="1200px" height="800"></iframe>
    </div>
